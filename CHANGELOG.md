...
- Changed: Builder/terminal `DEV_WORKSPACE_VERSION` in `docker/compose.yaml` updated to `1.8.15`.
...
- Added: GitHub Actions CI runs PHP and shell regression tests for pull requests and changes to `development`.
...
- Added: `templates/composer.plugin-check.json.dist` for the Plugin Check Composer repository and installer path.
...
- Fixed: Corrected the reference to the translations library.
